...
def patch_retrieve_persons_flow(test_func):
    patchers = [
        patch("generate_transcript.management.commands.load_elrr_records.get_elrr_persons"),
        patch("generate_transcript.management.commands.load_elrr_records.validate_person"),
        patch("generate_transcript.management.commands.load_elrr_records.get_elrr_record"),
    ...
    def wrapper(self):
        with patchers[0] as p0, patchers[1] as p1, patchers[2] as p2, \
             patchers[3] as p3, patchers[4] as p4, patchers[5] as p5, patchers[6] as p6:
