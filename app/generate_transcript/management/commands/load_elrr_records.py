...
class Command(BaseCommand):
    ...
    def load_occupations(self, user: UserRecord, records: dict) ->\
        ...
        for er in records['employment-record']:
            ...
            if 'positionDescription' in er and er['positionDescription']:
    ...
    def load_courses(self, user: UserRecord, records: dict) ->\
        ...
        for lr in records['learning-record']:
            defaults = {
                "experience_name": lr['learningResource']['title'],
            }
            if 'description' in lr['learningResource'] and\
                    lr['learningResource']['description']:
